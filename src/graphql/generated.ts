...
export type MyGetLessonBySlugQueryVariables = Exact<{
  slug?: InputMaybe<Scalars['String']>;
}>;


export type MyGetLessonBySlugQuery = { __typename?: 'Query', lesson?: { __typename?: 'Lesson', title: string, videoId: string, description?: string | null, teacher?: { __typename?: 'Teacher', name: string, bio: string, avatarURL: string } | null } | null };
...
export const MyGetLessonBySlugDocument = gql`
    query MyGetLessonBySlug($slug: String) {
...
/**
 * __useMyGetLessonBySlugQuery__
 *
 * To run a query within a React component, call `useMyGetLessonBySlugQuery` and pass it any options that fit your needs.
 * When your component renders, `useMyGetLessonBySlugQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useMyGetLessonBySlugQuery({
 *   variables: {
 *      slug: // value for 'slug'
 *   },
 * });
 */
export function useMyGetLessonBySlugQuery(baseOptions?: Apollo.QueryHookOptions<MyGetLessonBySlugQuery, MyGetLessonBySlugQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<MyGetLessonBySlugQuery, MyGetLessonBySlugQueryVariables>(MyGetLessonBySlugDocument, options);
      }
export function useMyGetLessonBySlugLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<MyGetLessonBySlugQuery, MyGetLessonBySlugQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<MyGetLessonBySlugQuery, MyGetLessonBySlugQueryVariables>(MyGetLessonBySlugDocument, options);
        }
export type MyGetLessonBySlugQueryHookResult = ReturnType<typeof useMyGetLessonBySlugQuery>;
export type MyGetLessonBySlugLazyQueryHookResult = ReturnType<typeof useMyGetLessonBySlugLazyQuery>;
export type MyGetLessonBySlugQueryResult = Apollo.QueryResult<MyGetLessonBySlugQuery, MyGetLessonBySlugQueryVariables>;